...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'txt_c3',
                type: 'text',
                rect: ['954', '946','139','108','auto', 'auto'],
                text: "와이퍼<br>스위치",
                align: "auto",
            ...
            },
            {
                id: 'txt2',
                type: 'text',
                rect: ['743px', '61px','1119px','106','auto', 'auto'],
                text: "운전석 와이퍼 스위치의 신호가 릴레이 박스를 통해<br>와이퍼 모터로 전송되어 와이퍼를 작동 시킵니다.",
                align: "auto",
            ...
            },
            {
                id: 'txt1',
                type: 'text',
                rect: ['43px', '70px','689px','76','auto', 'auto'],
                text: "와이퍼의 작동원리",
                align: "center",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid76", tween: [ "style", "${_txt_c3}", "opacity", '1', { fromValue: '0'}], position: 1266, duration: 434, easing: "easeOutQuad" },
                ...
                { id: "eid74", tween: [ "style", "${_txt_c1}", "opacity", '1', { fromValue: '0'}], position: 1266, duration: 434, easing: "easeOutQuad" },
                { id: "eid78", tween: [ "style", "${_FLOWS4}", "opacity", '1', { fromValue: '0'}], position: 1500, duration: 333, easing: "easeOutQuad" },
                { id: "eid72", tween: [ "style", "${_txt_c2}", "opacity", '1', { fromValue: '0'}], position: 1266, duration: 434, easing: "easeOutQuad" },
...
"WIPER": {
    ...
    content: {
            dom: [
                ...
                {
                    font: ['굴림', 50, 'rgb(0,113,187)', 'normal', 'none', 'normal'],
                    type: 'text',
                    align: 'auto',
                    id: 'txt_lowModeCopy',
                    text: '저속모드',
                    display: 'none',
                    rect: ['-234px', '85px', '204', '55', 'auto', 'auto']
                },
                {
                    font: ['굴림', 50, 'rgb(236,30,121)', 'normal', 'none', 'normal'],
                    type: 'text',
                    align: 'auto',
                    id: 'txt_highModeCopy',
                    text: '고속모드',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid43", tween: [ "style", "${_txt_lowModeCopy}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeOutQuad" },
                { id: "eid44", tween: [ "style", "${_txt_lowModeCopy}", "display", 'block', { fromValue: 'none'}], position: 133, duration: 0, easing: "easeOutQuad" },
                { id: "eid45", tween: [ "style", "${_txt_lowModeCopy}", "display", 'none', { fromValue: 'block'}], position: 3633, duration: 0, easing: "easeOutQuad" },
                ...
                { id: "eid42", tween: [ "style", "${_txt_highModeCopy}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeOutQuad" },
                { id: "eid46", tween: [ "style", "${_txt_highModeCopy}", "display", 'block', { fromValue: 'none'}], position: 3633, duration: 0, easing: "easeOutQuad" },
