...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                type: 'image',
                tag: 'img',
                rect: ['514px', '638','1188','463','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"flow_back.png"]
            },
            {
                id: 'FLOW4',
                type: 'rect',
                rect: ['661px', '900','auto','auto','auto', 'auto']
            },
            {
                id: 'FLOW2',
                type: 'rect',
                rect: ['620px', '663px','auto','auto','auto', 'auto'],
                transform: [[],['14']]
            },
            {
                id: 'FLOW3',
                type: 'rect',
                rect: ['682px', '644','auto','auto','auto', 'auto']
            },
            {
                id: 'FLOW1',
                type: 'rect',
                rect: ['634px', '631px','auto','auto','auto', 'auto'],
                transform: [[],['-19']]
            },
            {
                id: 'module_red',
                type: 'image',
                tag: 'img',
                rect: ['101px', '1037','416','125','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"module_red.png"]
            },
            {
                id: 'MODULE',
                type: 'rect',
                rect: ['557px', '601','auto','auto','auto', 'auto']
            },
            {
                id: 'SIGNAL',
                type: 'rect',
                rect: ['908px', '1116','auto','auto','auto', 'auto']
            },
            {
                id: 'key2',
                type: 'image',
                tag: 'img',
                rect: ['940px', '1091','177','90','auto', 'auto'],
            ...
            },
            {
                ...
                type: 'image',
                tag: 'img',
                rect: ['1243px', '253','230','230','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"key1.png"]
            },
            {
                id: 'txt_module_red',
                type: 'text',
                rect: ['162px', '1069','295','51','auto', 'auto'],
                text: "도어잠금 명령",
                align: "auto",
            ...
            },
            {
                id: 'txt_key_signal',
                type: 'text',
                rect: ['1180px', '1065','295','109','auto', 'auto'],
            ...
            },
            {
                id: 'IPM',
                type: 'text',
                rect: ['573px', '880px','82','51','auto', 'auto'],
                text: "IPM",
                align: "auto",
                font: ['굴림', 45, "rgb(0,0,0)", "normal", "none", "normal"]
            },
            {
                id: 'txt_c5',
                type: 'text',
                rect: ['1569px', '848','188','109','auto', 'auto'],
                text: "스마트키<br>유니트",
                align: "auto",
                font: ['굴림', 45, "rgb(0,0,0)", "normal", "none", "normal"]
            },
            {
                id: 'txt_c4',
                type: 'text',
                rect: ['1645px', '451','142','109','auto', 'auto'],
                text: "범퍼<br>안테나",
                align: "center",
                font: ['굴림', 45, "rgb(0,0,0)", "normal", "none", "normal"]
            },
            {
                id: 'txt_c3',
                type: 'text',
                rect: ['1421px', '705','234','51','auto', 'auto'],
                text: "실내안테나",
                align: "auto",
                font: ['굴림', 45, "rgb(0,0,0)", "normal", "none", "normal"]
            },
            {
                id: 'txt_c2',
                type: 'text',
                rect: ['1040px', '705','234','51','auto', 'auto'],
                text: "실내안테나",
                align: "auto",
                font: ['굴림', 45, "rgb(0,0,0)", "normal", "none", "normal"]
            },
            {
                id: 'txt_c1',
                type: 'text',
                rect: ['380px', '619','215','51','auto', 'auto'],
                text: "RF 수신기",
                align: "auto",
                font: ['굴림', 45, "rgb(0,0,0)", "normal", "none", "normal"]
            },
            {
                id: 'txt2',
                type: 'text',
                rect: ['569', '68','1213','106','auto', 'auto'],
            ...
            },
            {
                id: 'txt1',
                type: 'text',
                rect: ['30px', '41','527px','145','auto', 'auto'],
                text: "도어잠금기능<br>(LOCK)",
                align: "center",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid339", tween: [ "style", "${_FLOW2}", "-moz-transform-origin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" },
                { id: "eid340", tween: [ "style", "${_FLOW2}", "-ms-transform-origin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" },
                { id: "eid341", tween: [ "style", "${_FLOW2}", "msTransformOrigin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" },
                { id: "eid342", tween: [ "style", "${_FLOW2}", "-o-transform-origin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" },
                ...
                { id: "eid180", tween: [ "style", "${_module_red}", "opacity", '1', { fromValue: '0'}], position: 1112, duration: 403, easing: "easeInQuad" },
                ...
                { id: "eid168", tween: [ "style", "${_car}", "left", '73px', { fromValue: '143px'}], position: 289, duration: 498, easing: "easeInQuad" },
                ...
                { id: "eid343", tween: [ "style", "${_FLOW1}", "-moz-transform-origin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" },
                { id: "eid344", tween: [ "style", "${_FLOW1}", "-ms-transform-origin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" },
                { id: "eid345", tween: [ "style", "${_FLOW1}", "msTransformOrigin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" },
                { id: "eid346", tween: [ "style", "${_FLOW1}", "-o-transform-origin", [0,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,50]}], position: 813, duration: 0, easing: "easeInQuad" }            ]
        }
    }
},
"MODULE": {
