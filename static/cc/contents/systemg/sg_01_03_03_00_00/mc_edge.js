...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'generator_ov',
                type: 'image',
                rect: ['1022px', '716px','109px','94px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"generator_ov.png",'0px','0px']
            },
            {
                id: 'radiator',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid349", tween: [ "style", "${_generator_ov}", "opacity", '1', { fromValue: '0'}], position: 600, duration: 248 },
