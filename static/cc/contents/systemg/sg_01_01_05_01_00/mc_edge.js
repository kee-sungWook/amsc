...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'inhalation_ov',
                type: 'image',
                rect: ['498px', '379px','336px','226px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"inhalation_ov.png",'0px','0px']
            },
            {
                id: 'hose01-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid71", tween: [ "style", "${_inhalation_ov}", "opacity", '1', { fromValue: '0'}], position: 675, duration: 250 },
