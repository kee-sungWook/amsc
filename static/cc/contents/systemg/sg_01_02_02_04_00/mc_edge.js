...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'crank_o1',
            type:'image',
            rect:['356px','612px','72px','71px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"crank_o1.png",'0px','0px']
         },
         {
            id:'cam-copy',
            type:'image',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid36", tween: [ "style", "${_crank_o1}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 250 },
