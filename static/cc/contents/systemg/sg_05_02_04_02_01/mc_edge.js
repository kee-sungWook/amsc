...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                tag: 'img',
                rect: ['1546', '33','762','569','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_shackle.png"]
            },
            {
                id: 'text',
                type: 'text',
                rect: ['1665', '726','618','182','auto', 'auto'],
                text: "리어 스프링 샤클<br>어셈블리",
                align: "center",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid46", tween: [ "style", "${_SELECT_shackle}", "opacity", '1', { fromValue: '0'}], position: 1100, duration: 367, easing: "easeOutQuad" },
