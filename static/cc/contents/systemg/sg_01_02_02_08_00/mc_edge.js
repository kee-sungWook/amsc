...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'TPS_ov',
                type: 'image',
                rect: ['773px', '284px','33px','20px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"TPS_ov.png",'0px','0px']
            },
            {
                id: 'MAP-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid53", tween: [ "style", "${_TPS_ov}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 250 },
                ...
                { id: "eid51", tween: [ "style", "${_TPS-copy}", "left", '772px', { fromValue: '772px'}], position: 750, duration: 0 }            ]
        }
    }
}
};
