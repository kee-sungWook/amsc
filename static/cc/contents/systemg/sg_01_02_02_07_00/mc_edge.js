...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'OCV_ov',
                type: 'image',
                rect: ['516px', '248px','72px','72px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"OCV_ov.png",'0px','0px']
            },
            {
                id: 'valve-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid42", tween: [ "style", "${_OCV_ov}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 250 },
