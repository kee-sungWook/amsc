...
"stage": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid39", tween: [ "transform", "${_sPic6}", "scaleX", '1', { fromValue: '0.9'}], position: 513, duration: 233, easing: "easeOutQuad" },
                { id: "eid23", tween: [ "style", "${_sPic6}", "opacity", '1', { fromValue: '0'}], position: 513, duration: 233, easing: "easeOutQuad" },
                ...
                { id: "eid25", tween: [ "style", "${_sPic5}", "opacity", '1', { fromValue: '0'}], position: 443, duration: 233, easing: "easeOutQuad" },
                ...
                { id: "eid41", tween: [ "transform", "${_sPic6}", "scaleY", '1', { fromValue: '0.9'}], position: 513, duration: 233, easing: "easeOutQuad" },
                ...
                { id: "eid45", tween: [ "transform", "${_sPic5}", "scaleY", '1', { fromValue: '0.9'}], position: 443, duration: 233, easing: "easeOutQuad" },
                { id: "eid21", tween: [ "style", "${_sPic4}", "opacity", '1', { fromValue: '0'}], position: 373, duration: 233, easing: "easeOutQuad" },
                { id: "eid43", tween: [ "transform", "${_sPic5}", "scaleX", '1', { fromValue: '0.9'}], position: 443, duration: 233, easing: "easeOutQuad" }            ]
        }
    }
},
"sPic1": {
