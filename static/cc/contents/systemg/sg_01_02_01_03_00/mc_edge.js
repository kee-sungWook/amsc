...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'pressure_ov',
                type: 'image',
                rect: ['364px', '488px','69px','46px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"pressure_ov.png",'0px','0px']
            },
            {
                id: 'gray_ov',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid19", tween: [ "style", "${_cap-copy}", "opacity", '1', { fromValue: '0'}], position: 458, duration: 250 },
                ...
                { id: "eid17", tween: [ "style", "${_tank-copy}", "opacity", '1', { fromValue: '0'}], position: 458, duration: 250 },
                { id: "eid13", tween: [ "style", "${_canister-copy}", "opacity", '1', { fromValue: '0'}], position: 458, duration: 250 },
                { id: "eid9", tween: [ "style", "${_fuel}", "opacity", '1', { fromValue: '0'}], position: 458, duration: 250 },
                { id: "eid26", tween: [ "style", "${_pressure_ov}", "opacity", '1', { fromValue: '0'}], position: 708, duration: 250 },
                { id: "eid11", tween: [ "style", "${_pressure-copy}", "opacity", '1', { fromValue: '0'}], position: 458, duration: 250 },
                { id: "eid15", tween: [ "style", "${_motor-copy}", "opacity", '1', { fromValue: '0'}], position: 458, duration: 250 }            ]
        }
    }
}
};
