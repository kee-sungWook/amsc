...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'flap_ov',
                type: 'image',
                rect: ['626px', '597px','102px','132px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"flap_ov.png",'0px','0px']
            },
            {
                id: 'pump-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid33", tween: [ "style", "${_flap_ov}", "opacity", '1', { fromValue: '0'}], position: 625, duration: 83 },
