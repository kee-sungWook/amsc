...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'electric_ov',
                type: 'image',
                rect: ['877px', '578px','51px','99px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"electric_ov.png",'0px','0px']
            },
            {
                id: 'radiator',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid353", tween: [ "style", "${_electric_ov}", "opacity", '1', { fromValue: '0'}], position: 619, duration: 248 },
