...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_TOP-RL_spring',
                type: 'image',
                tag: 'img',
                rect: ['487', '229','534','152','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"TOP-RL_spring-1.png"]
            },
            {
                id: 'TOP-shackle',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid57", tween: [ "style", "${_TOP-Tire}", "opacity", '0.27346928590009', { fromValue: '0.6000000238418579'}], position: 967, duration: 366, easing: "easeOutQuad" },
                ...
                { id: "eid52", tween: [ "style", "${_SELECT_TOP-RL_spring}", "opacity", '1', { fromValue: '0'}], position: 967, duration: 366, easing: "easeOutQuad" }            ]
        }
    }
}
};
