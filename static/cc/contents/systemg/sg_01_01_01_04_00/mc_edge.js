   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid40", tween: [ "style", "${_thermostat2}", "top", '305px', { fromValue: '491px'}], position: 476, duration: 233 },
            { id: "eid36", tween: [ "style", "${_thermostat1}", "top", '345px', { fromValue: '513px'}], position: 476, duration: 233 },
            ...
            { id: "eid42", tween: [ "style", "${_thermostat3}", "left", '488px', { fromValue: '486px'}], position: 476, duration: 233 },
            ...
            { id: "eid170", tween: [ "style", "${_thermostat3ov}", "opacity", '1', { fromValue: '0'}], position: 711, duration: 89 },
            ...
            { id: "eid44", tween: [ "style", "${_thermostat3}", "top", '273px', { fromValue: '486px'}], position: 476, duration: 233 },
            ...
            { id: "eid38", tween: [ "style", "${_thermostat2}", "left", '561px', { fromValue: '491px'}], position: 476, duration: 233 },
            ...
            { id: "eid46", tween: [ "style", "${_thermostat4}", "left", '351px', { fromValue: '443px'}], position: 476, duration: 233 },
            { id: "eid56", tween: [ "transform", "${_engineBody}", "scaleX", '1', { fromValue: '1.1'}], position: 0, duration: 183 },
            { id: "eid48", tween: [ "style", "${_thermostat4}", "top", '237px', { fromValue: '482px'}], position: 476, duration: 233 },
            ...
            { id: "eid34", tween: [ "style", "${_thermostat1}", "left", '690px', { fromValue: '551px'}], position: 476, duration: 233 },
