...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_prop_valve',
                type: 'image',
                tag: 'img',
                rect: ['60', '940','139','138','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_prop_valve.png"]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid188", tween: [ "style", "${_SELECT_prop_valve}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
