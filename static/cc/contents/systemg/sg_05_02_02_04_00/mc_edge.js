...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_shock_absorber',
                type: 'image',
                tag: 'img',
                rect: ['579', '73','282','493','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_shock_absorber.png"]
            },
            {
                id: 'lowerArm',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid60", tween: [ "style", "${_SELECT_shock_absorber}", "opacity", '1', { fromValue: '0'}], position: 1000, duration: 333, easing: "easeOutQuad" },
