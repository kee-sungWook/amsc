...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_m_Cylinder-7',
                type: 'image',
                tag: 'img',
                rect: ['704', '509','32','39','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_m_Cylinder-7.png"]
            },
            {
                id: 'SELECT_m_Cylinder-6',
                type: 'image',
                tag: 'img',
                rect: ['525', '528','177','128','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_m_Cylinder-6.png"]
            },
            {
                id: 'SELECT_m_Cylinder-5',
                type: 'image',
                tag: 'img',
                rect: ['326', '637','189','132','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_m_Cylinder-5.png"]
            },
            {
                id: 'SELECT_m_Cylinder-4',
                type: 'image',
                tag: 'img',
                rect: ['29', '721','342','250','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_m_Cylinder-4.png"]
            },
            {
                id: 'SELECT_m_Cylinder-3',
                type: 'image',
                tag: 'img',
                rect: ['120', '729','12','50','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_m_Cylinder-3.png"]
            },
            {
                id: 'SELECT_m_Cylinder-2',
                type: 'image',
                tag: 'img',
                rect: ['98', '666','56','50','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_m_Cylinder-2.png"]
            },
            {
                id: 'SELECT_m_Cylinder-1',
                type: 'image',
                tag: 'img',
                rect: ['206', '601','56','49','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_m_Cylinder-1.png"]
            }],
            symbolInstances: [
    ...
    states: {
        "Base State": {
            ...
            "${_SELECT_m_Cylinder-3}": [
                ["style", "opacity", '0']
            ],
            "${_SELECT_m_Cylinder-7}": [
                ["style", "opacity", '0']
            ],
            "${_SELECT_m_Cylinder-5}": [
                ["style", "opacity", '0']
            ],
            "${_SELECT_m_Cylinder-1}": [
                ["style", "opacity", '0']
            ],
            "${_m_Cylinder-6}": [
                ["style", "top", '545px'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid194", tween: [ "style", "${_SELECT_m_Cylinder-1}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid198", tween: [ "style", "${_SELECT_m_Cylinder-7}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid182", tween: [ "style", "${_SELECT_m_Cylinder-2}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid176", tween: [ "style", "${_SELECT_m_Cylinder-4}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid184", tween: [ "style", "${_SELECT_m_Cylinder-3}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid186", tween: [ "style", "${_SELECT_m_Cylinder-6}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid208", tween: [ "style", "${_SELECT_m_Cylinder-5}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
