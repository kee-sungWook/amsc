...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'vapor_ov',
                type: 'image',
                rect: ['460px', '678px','115px','112px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"vapor_ov.png",'0px','0px']
            },
            {
                id: 'hose-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid60", tween: [ "style", "${_vapor_ov}", "opacity", '1', { fromValue: '0'}], position: 417, duration: 250 },
