...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'electric01ov',
                type: 'image',
                rect: ['805px', '613px','36px','70px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"electric01ov.png",'0px','0px']
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid357", tween: [ "style", "${_electric01ov}", "opacity", '1', { fromValue: '0'}], position: 552, duration: 248 },
