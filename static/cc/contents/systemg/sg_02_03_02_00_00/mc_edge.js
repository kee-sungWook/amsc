...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                type: 'image',
                tag: 'img',
                rect: ['414', '46','439','842','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"BACK.png"]
            },
            {
                id: 'moving_parts',
                type: 'rect',
                rect: ['373', '159','auto','auto','auto', 'auto']
            },
            {
                id: 'BACK-TOP',
                type: 'image',
                tag: 'img',
                rect: ['434', '239','158','463','auto', 'auto'],
            ...
            },
            {
                ...
                type: 'image',
                tag: 'img',
                rect: ['584', '716','694','389','auto', 'auto'],
            ...
            },
            {
                ...
                type: 'image',
                tag: 'img',
                rect: ['1135', '588','323','101','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"M_cylinder_oil1.png"]
            },
            {
                id: 'oilColorMovie',
                type: 'rect',
                rect: ['584', '598','auto','auto','auto', 'auto']
            },
            {
                id: 'oilFlowAreas',
                type: 'rect',
                rect: ['583', '716','auto','auto','auto', 'auto']
            },
            {
                id: 'oilLine',
                type: 'image',
                tag: 'img',
                rect: ['686', '712','598','249','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"oilLine.png"]
            },
            {
                id: 'o_cylinder_sub',
                type: 'rect',
                rect: ['388', '1013','auto','auto','auto', 'auto']
            },
            {
                id: 'o_cylinder',
                type: 'image',
                tag: 'img',
                rect: ['522', '931','265','253','auto', 'auto'],
            ...
            },
            {
                ...
                type: 'image',
                tag: 'img',
                rect: ['1136', '528','340','192','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"M_cylinder.png"]
            },
            {
                id: 'pedal_piston',
                type: 'rect',
                rect: ['1237', '511','auto','auto','auto', 'auto']
            },
            {
                id: 'oilCask',
                type: 'image',
                tag: 'img',
                rect: ['995', '181','346','442','auto', 'auto'],
