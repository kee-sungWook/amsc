...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'cap_ov',
                type: 'image',
                rect: ['1320px', '472px','57px','57px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"cap_ov.png",'0px','0px']
            },
            {
                id: 'motor-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid32", tween: [ "style", "${_cap_ov}", "opacity", '1', { fromValue: '0'}], position: 708, duration: 250 },
