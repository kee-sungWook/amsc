...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'thermostat3ov',
                type: 'image',
                rect: ['488px', '273px','59px','64px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"thermostat3ov.png",'0px','0px']
            },
            {
                id: 'thermostat2',
                type: 'image',
            ...
            },
            {
                id: 'w_pump_ov',
                type: 'image',
                rect: ['757px', '371px','194px','164px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"w_pump_ov.png",'0px','0px']
            },
            {
                id: 'w_pump_pulley',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid109", tween: [ "transform", "${_thermostat3}", "scaleY", '1', { fromValue: '1.1'}], position: 32, duration: 183 },
                { id: "eid40", tween: [ "style", "${_thermostat2}", "top", '305px', { fromValue: '491px'}], position: 333, duration: 143 },
                { id: "eid36", tween: [ "style", "${_thermostat1}", "top", '345px', { fromValue: '513px'}], position: 333, duration: 141 },
                { id: "eid107", tween: [ "transform", "${_thermostat3}", "scaleX", '1', { fromValue: '1.1'}], position: 32, duration: 183 },
                { id: "eid82", tween: [ "transform", "${_w_pump}", "scaleY", '1', { fromValue: '1.1'}], position: 84, duration: 183 },
                { id: "eid105", tween: [ "style", "${_thermostat3}", "left", '486px', { fromValue: '486px'}], position: 32, duration: 0 },
                { id: "eid42", tween: [ "style", "${_thermostat3}", "left", '488px', { fromValue: '486px'}], position: 333, duration: 138 },
                { id: "eid102", tween: [ "transform", "${_thermostat2}", "scaleY", '1', { fromValue: '1.1'}], position: 84, duration: 183 },
                { id: "eid116", tween: [ "transform", "${_thermostat4}", "scaleY", '1', { fromValue: '1.1'}], position: 32, duration: 183 },
                { id: "eid80", tween: [ "transform", "${_w_pump}", "scaleX", '1', { fromValue: '1.1'}], position: 84, duration: 183 },
                { id: "eid172", tween: [ "style", "${_w_pump_ov}", "opacity", '1', { fromValue: '0'}], position: 417, duration: 90 },
                { id: "eid64", tween: [ "transform", "${_radiator}", "scaleX", '1', { fromValue: '1.1'}], position: 84, duration: 183 },
                { id: "eid44", tween: [ "style", "${_thermostat3}", "top", '273px', { fromValue: '486px'}], position: 333, duration: 138 },
                ...
                { id: "eid118", tween: [ "style", "${_thermostat4}", "opacity", '1', { fromValue: '0'}], position: 32, duration: 183 },
                { id: "eid24", tween: [ "style", "${_drive_belt}", "top", '481px', { fromValue: '566px'}], position: 333, duration: 139 },
                { id: "eid18", tween: [ "style", "${_c_fan_clutch}", "left", '569px', { fromValue: '506px'}], position: 333, duration: 138 },
                { id: "eid28", tween: [ "style", "${_w_pump_pulley}", "top", '460px', { fromValue: '545px'}], position: 333, duration: 134 },
                ...
                { id: "eid53", tween: [ "style", "${_engineBody}", "left", '558px', { fromValue: '558px'}], position: 157, duration: 0 },
                { id: "eid50", tween: [ "style", "${_engineBody}", "left", '879px', { fromValue: '558px'}], position: 333, duration: 135 },
                { id: "eid20", tween: [ "style", "${_c_fan_clutch}", "top", '516px', { fromValue: '572px'}], position: 333, duration: 138 },
                ...
                { id: "eid60", tween: [ "style", "${_engineBody}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 157 },
                { id: "eid12", tween: [ "style", "${_radiator}", "top", '600px', { fromValue: '453px'}], position: 333, duration: 139 },
                ...
                { id: "eid10", tween: [ "style", "${_radiator}", "left", '64px', { fromValue: '280px'}], position: 333, duration: 139 },
                { id: "eid56", tween: [ "transform", "${_engineBody}", "scaleX", '1', { fromValue: '1.1'}], position: 0, duration: 157 },
                { id: "eid119", tween: [ "style", "${_radiator_cap}", "left", '432px', { fromValue: '432px'}], position: 84, duration: 0 },
                { id: "eid6", tween: [ "style", "${_radiator_cap}", "left", '216px', { fromValue: '432px'}], position: 333, duration: 138 },
                { id: "eid22", tween: [ "style", "${_drive_belt}", "left", '517px', { fromValue: '415px'}], position: 333, duration: 139 },
                ...
                { id: "eid2", tween: [ "style", "${_BUDONGAEK}", "left", '251px', { fromValue: '467px'}], position: 333, duration: 138 },
                { id: "eid4", tween: [ "style", "${_BUDONGAEK}", "top", '692px', { fromValue: '545px'}], position: 333, duration: 138 },
                ...
                { id: "eid30", tween: [ "style", "${_w_pump}", "left", '757px', { fromValue: '558px'}], position: 333, duration: 141 },
                { id: "eid112", tween: [ "style", "${_thermostat4}", "left", '443px', { fromValue: '443px'}], position: 32, duration: 0 },
                { id: "eid46", tween: [ "style", "${_thermostat4}", "left", '351px', { fromValue: '443px'}], position: 333, duration: 137 },
                { id: "eid88", tween: [ "transform", "${_w_pump_pulley}", "scaleX", '1', { fromValue: '1.1'}], position: 84, duration: 183 },
                { id: "eid48", tween: [ "style", "${_thermostat4}", "top", '237px', { fromValue: '482px'}], position: 333, duration: 137 },
                { id: "eid52", tween: [ "style", "${_engineBody}", "top", '91px', { fromValue: '244px'}], position: 333, duration: 135 },
                { id: "eid98", tween: [ "style", "${_thermostat2}", "left", '491px', { fromValue: '491px'}], position: 84, duration: 0 },
                { id: "eid38", tween: [ "style", "${_thermostat2}", "left", '561px', { fromValue: '491px'}], position: 333, duration: 143 },
                { id: "eid58", tween: [ "transform", "${_engineBody}", "scaleY", '1', { fromValue: '1.1'}], position: 0, duration: 157 },
                { id: "eid114", tween: [ "transform", "${_thermostat4}", "scaleX", '1', { fromValue: '1.1'}], position: 32, duration: 183 },
                { id: "eid32", tween: [ "style", "${_w_pump}", "top", '371px', { fromValue: '522px'}], position: 333, duration: 141 },
                { id: "eid131", tween: [ "transform", "${_c_fan}", "scaleY", '1', { fromValue: '1.1'}], position: 84, duration: 183 },
                { id: "eid8", tween: [ "style", "${_radiator_cap}", "top", '658px', { fromValue: '511px'}], position: 333, duration: 138 },
                ...
                { id: "eid26", tween: [ "style", "${_w_pump_pulley}", "left", '667px', { fromValue: '565px'}], position: 333, duration: 134 },
                { id: "eid76", tween: [ "style", "${_BUDONGAEK}", "opacity", '1', { fromValue: '0'}], position: 84, duration: 183 },
                { id: "eid111", tween: [ "style", "${_thermostat3}", "opacity", '1', { fromValue: '0'}], position: 32, duration: 183 },
                ...
                { id: "eid34", tween: [ "style", "${_thermostat1}", "left", '690px', { fromValue: '551px'}], position: 333, duration: 141 },
