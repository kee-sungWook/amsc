...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'rail_ov',
                type: 'image',
                rect: ['399px', '566px','391px','34px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"rail_ov.png",'0px','0px']
            },
            {
                id: 'iniecter-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid31", tween: [ "style", "${_rail_ov}", "opacity", '1', { fromValue: '0'}], position: 667, duration: 41 },
