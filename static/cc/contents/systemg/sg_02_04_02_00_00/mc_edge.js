...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                tag: 'img',
                rect: ['840', '411','249','183','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c8.png"]
            },
            {
                id: 'SEL_dif_c7',
                type: 'image',
                tag: 'img',
                rect: ['839', '536','34','41','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c7.png"]
            },
            {
                id: 'SEL_dif_c6',
                type: 'image',
                tag: 'img',
                rect: ['820', '549','23','27','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c6.png"]
            },
            {
                id: 'SEL_dif_c5',
                type: 'image',
                tag: 'img',
                rect: ['794', '551','30','36','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c5.png"]
            },
            {
                id: 'SEL_dif_c4',
                type: 'image',
                tag: 'img',
                rect: ['772', '554','27','42','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c4.png"]
            },
            {
                id: 'SEL_dif_c3',
                type: 'image',
                tag: 'img',
                rect: ['746', '566','29','35','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c3.png"]
            },
            {
                id: 'SEL_dif_c2',
                type: 'image',
                tag: 'img',
                rect: ['687', '556','63','75','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c2.png"]
            },
            {
                id: 'SEL_dif_c1',
                type: 'image',
                tag: 'img',
                rect: ['657', '593','28','33','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SEL_dif_c1.png"]
            },
            {
                id: 'cv_joint',
                type: 'rect',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid94", tween: [ "style", "${_SEL_dif_c5}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
                ...
                { id: "eid86", tween: [ "style", "${_SEL_dif_c8}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
                { id: "eid70", tween: [ "style", "${_driveShaft}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 400, easing: "easeInQuad" },
                { id: "eid78", tween: [ "style", "${_SEL_dif_c1}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
                { id: "eid50", tween: [ "style", "${_driveShaft}", "top", '569px', { fromValue: '501px'}], position: 433, duration: 333, easing: "easeOutQuad" },
                { id: "eid90", tween: [ "style", "${_SEL_dif_c7}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
                { id: "eid92", tween: [ "style", "${_SEL_dif_c3}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
                { id: "eid84", tween: [ "style", "${_SEL_dif_c2}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
                ...
                { id: "eid80", tween: [ "style", "${_SEL_dif_c4}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
                { id: "eid96", tween: [ "style", "${_SEL_dif_c6}", "opacity", '1', { fromValue: '0'}], position: 1167, duration: 266, easing: "easeInQuad" },
