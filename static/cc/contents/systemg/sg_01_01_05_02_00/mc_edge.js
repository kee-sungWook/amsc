...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'ex_ov',
                type: 'image',
                rect: ['406px', '527px','302px','244px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"ex_ov.png",'0px','0px']
            },
            {
                id: 'air-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid73", tween: [ "style", "${_ex_ov}", "opacity", '1', { fromValue: '0'}], position: 816, duration: 250 },
