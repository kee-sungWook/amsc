...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'top_ov',
                type: 'image',
                rect: ['830px', '499px','172px','100px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"top_ov.png",'0px','0px']
            },
            {
                id: 'ut-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid81", tween: [ "style", "${_top_ov}", "opacity", '1', { fromValue: '0'}], position: 874, duration: 250 },
