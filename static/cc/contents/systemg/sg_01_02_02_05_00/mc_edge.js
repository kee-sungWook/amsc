...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'valve_ov',
                type: 'image',
                rect: ['743px', '530px','21px','27px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"valve_ov.png",'0px','0px']
            },
            {
                id: 'crank-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid38", tween: [ "style", "${_valve_ov}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 250 },
