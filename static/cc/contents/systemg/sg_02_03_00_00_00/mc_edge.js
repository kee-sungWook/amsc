...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Mmission',
                type: 'image',
                rect: ['748px', '570px','223px','207px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"Mmission.png",'0px','0px']
            },
            {
                id: 'clutch',
                type: 'image',
                rect: ['932px', '691px','78px','97px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"clutch.png",'0px','0px']
            },
            {
                id: 'select_clutch',
                type: 'image',
                rect: ['932px', '691px','78px','97px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"select_clutch.png",'0px','0px']
            },
            {
                id: 'engine',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid212", tween: [ "transform", "${_engine}", "scaleY", '1', { fromValue: '1.1'}], position: 539, duration: 185 },
                ...
                { id: "eid210", tween: [ "transform", "${_engine}", "scaleX", '1', { fromValue: '1.1'}], position: 539, duration: 185 },
                { id: "eid109", tween: [ "transform", "${_frontWheel}", "scaleY", '1', { fromValue: '1.1'}], position: 300, duration: 248 },
                { id: "eid366", tween: [ "style", "${_Mmission}", "opacity", '0.8', { fromValue: '0'}], position: 400, duration: 234 },
                { id: "eid377", tween: [ "style", "${_Mmission}", "opacity", '0.4', { fromValue: '0.8'}], position: 634, duration: 51 },
                { id: "eid376", tween: [ "transform", "${_clutch}", "scaleY", '1', { fromValue: '1.1'}], position: 433, duration: 285 },
                { id: "eid94", tween: [ "transform", "${_rearWheel}", "scaleX", '1', { fromValue: '1.1'}], position: 219, duration: 248 },
                { id: "eid368", tween: [ "style", "${_clutch}", "opacity", '0.8', { fromValue: '0'}], position: 433, duration: 285 },
                { id: "eid12", tween: [ "style", "${_tire1_shadow}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 200 },
                { id: "eid374", tween: [ "transform", "${_clutch}", "scaleX", '1', { fromValue: '1.1'}], position: 433, duration: 285 },
                { id: "eid32", tween: [ "transform", "${_r_brake2}", "scaleY", '1', { fromValue: '1.1'}], position: 185, duration: 248 },
                { id: "eid372", tween: [ "transform", "${_Mmission}", "scaleY", '1', { fromValue: '1.1'}], position: 400, duration: 285 },
                { id: "eid386", tween: [ "style", "${_select_clutch}", "opacity", '1', { fromValue: '0'}], position: 800, duration: 200 },
                ...
                { id: "eid208", tween: [ "style", "${_engine}", "opacity", '1', { fromValue: '0'}], position: 539, duration: 185 },
                { id: "eid341", tween: [ "style", "${_engine}", "opacity", '0.4', { fromValue: '1'}], position: 724, duration: 28 },
                { id: "eid387", tween: [ "style", "${_engine}", "opacity", '0.25', { fromValue: '0.4000000059604645'}], position: 800, duration: 200 },
                ...
                { id: "eid370", tween: [ "transform", "${_Mmission}", "scaleX", '1', { fromValue: '1.1'}], position: 400, duration: 285 },
