...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_disk_brake',
                type: 'image',
                tag: 'img',
                rect: ['728', '628','567','289','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_disk_brake.png"]
            },
            {
                id: 'Line_Sensor',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid436", tween: [ "style", "${_SELECT_disk_brake}", "opacity", '1', { fromValue: '0'}], position: 1500, duration: 233, easing: "easeInQuad" },
