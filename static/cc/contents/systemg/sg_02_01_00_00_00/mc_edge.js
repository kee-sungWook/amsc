...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Amission',
                type: 'image',
                rect: ['748px', '652px','223px','125px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"Amission.png",'0px','0px']
            },
            {
                id: 'select_Amission',
                type: 'image',
                rect: ['748px', '652px','223px','125px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"select_Amission.png",'0px','0px']
            },
            {
                id: 'engine',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid357", tween: [ "style", "${_Amission}", "opacity", '1', { fromValue: '0'}], position: 433, duration: 252 },
                { id: "eid362", tween: [ "style", "${_Amission}", "opacity", '0.4', { fromValue: '1'}], position: 685, duration: 33 },
                ...
                { id: "eid364", tween: [ "style", "${_select_Amission}", "opacity", '1', { fromValue: '0'}], position: 800, duration: 200 },
                ...
                { id: "eid359", tween: [ "transform", "${_Amission}", "scaleX", '1', { fromValue: '1.1'}], position: 433, duration: 285 },
                ...
                { id: "eid361", tween: [ "transform", "${_Amission}", "scaleY", '1', { fromValue: '1.1'}], position: 433, duration: 285 },
