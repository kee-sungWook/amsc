...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'inter_ov',
                type: 'image',
                rect: ['422px', '785px','148px','207px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"inter_ov.png",'0px','0px']
            },
            {
                id: 'inhalation-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid79", tween: [ "style", "${_inter_ov}", "opacity", '1', { fromValue: '0'}], position: 874, duration: 250 },
