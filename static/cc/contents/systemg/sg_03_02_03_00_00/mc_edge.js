...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                tag: 'img',
                rect: ['712', '318','286','265','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_h_bag-4.png"]
            },
            {
                id: 'SELECT_h_bag-3',
                type: 'image',
                tag: 'img',
                rect: ['724', '355','16','16','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_h_bag-3.png"]
            },
            {
                id: 'SELECT_h_bag-2',
                type: 'image',
                tag: 'img',
                rect: ['533', '228','206','119','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_h_bag-2.png"]
            },
            {
                id: 'SELECT_h_bag-1',
                type: 'image',
                tag: 'img',
                rect: ['509', '267','17','18','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_h_bag-1.png"]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid206", tween: [ "style", "${_SELECT_h_bag-4}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                { id: "eid154", tween: [ "style", "${_prop_valve}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 333, easing: "easeInQuad" },
                { id: "eid178", tween: [ "style", "${_SELECT_h_bag-3}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid204", tween: [ "style", "${_SELECT_h_bag-2}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid190", tween: [ "style", "${_SELECT_h_bag-1}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
