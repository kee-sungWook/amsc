...
"stage": {
    ...
    content: {
            ...
            {
                id: 'select_control_valve',
                type: 'image',
                tag: 'img',
                rect: ['1168', '499','98','72','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"select_control_valve.png"]
            },
            {
                id: 'ecu',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid448", tween: [ "style", "${_select_control_valve}", "opacity", '1', { fromValue: '0'}], position: 1834, duration: 333, easing: "easeInQuad" },
