...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_brakeOil-2',
                type: 'image',
                tag: 'img',
                rect: ['20', '320','303','300','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_brakeOil-2.png"]
            },
            {
                id: 'SELECT_brakeOil-1',
                type: 'image',
                tag: 'img',
                rect: ['33', '173','170','131','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_brakeOil-1.png"]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid200", tween: [ "style", "${_SELECT_brakeOil-1}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
                ...
                { id: "eid192", tween: [ "style", "${_SELECT_brakeOil-2}", "opacity", '1', { fromValue: '0'}], position: 900, duration: 367, easing: "easeOutQuad" },
