...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${sPic1}", "click", function(sym, e) {
         sym.getSymbol("bPic").play("pic1");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${sPic2}", "click", function(sym, e) {
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-26846989");