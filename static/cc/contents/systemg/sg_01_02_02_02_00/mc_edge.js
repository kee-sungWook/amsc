...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'cam_ov',
            type:'image',
            rect:['496px','474px','226px','108px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"cam_ov.png",'0px','0px']
         },
         {
            id:'IMAGE_ov',
            type:'image',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid31", tween: [ "style", "${_cam_ov}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 250 },
