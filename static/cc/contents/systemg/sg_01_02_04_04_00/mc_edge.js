...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'mixer_ov',
                type: 'image',
                rect: ['497px', '579px','80px','89px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"mixer_ov.png",'0px','0px']
            },
            {
                id: 'vapor-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid62", tween: [ "style", "${_mixer_ov}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 250 },
