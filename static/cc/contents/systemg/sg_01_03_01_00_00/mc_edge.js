...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'battery',
                type: 'image',
                rect: ['828px', '663px','203px','266px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"battery.png",'0px','0px']
            },
            {
                id: 'radiator',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid347", tween: [ "style", "${_battery}", "opacity", '1', { fromValue: '0'}], position: 600, duration: 248 },
