...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_brakeSystem',
                type: 'image',
                tag: 'img',
                rect: ['234', '491','1015','391','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_brakeSystem.png"]
            },
            {
                id: 'P_brake',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid432", tween: [ "style", "${_SELECT_brakeSystem}", "opacity", '1', { fromValue: '0'}], position: 1500, duration: 233, easing: "easeInQuad" },
