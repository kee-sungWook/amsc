...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'pump_ov',
                type: 'image',
                rect: ['782px', '484px','72px','108px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"pump_ov.png",'0px','0px']
            },
            {
                id: 'rail-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid27", tween: [ "style", "${_pump_ov}", "opacity", '1', { fromValue: '0'}], position: 650, duration: 58 },
