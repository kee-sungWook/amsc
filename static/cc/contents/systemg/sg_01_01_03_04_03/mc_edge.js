...
"stage": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid39", tween: [ "transform", "${_sPic6}", "scaleX", '1', { fromValue: '0.9'}], position: 514, duration: 233, easing: "easeOutQuad" },
                { id: "eid23", tween: [ "style", "${_sPic6}", "opacity", '1', { fromValue: '0'}], position: 514, duration: 233, easing: "easeOutQuad" },
                ...
                { id: "eid25", tween: [ "style", "${_sPic5}", "opacity", '1', { fromValue: '0'}], position: 444, duration: 233, easing: "easeOutQuad" },
                ...
                { id: "eid41", tween: [ "transform", "${_sPic6}", "scaleY", '1', { fromValue: '0.9'}], position: 514, duration: 233, easing: "easeOutQuad" },
                ...
                { id: "eid45", tween: [ "transform", "${_sPic5}", "scaleY", '1', { fromValue: '0.9'}], position: 444, duration: 233, easing: "easeOutQuad" },
                { id: "eid55", tween: [ "style", "${_bPic}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 257, easing: "easeOutQuad" },
                { id: "eid43", tween: [ "transform", "${_sPic5}", "scaleX", '1', { fromValue: '0.9'}], position: 444, duration: 233, easing: "easeOutQuad" }            ]
        }
    }
},
"sPic1": {
