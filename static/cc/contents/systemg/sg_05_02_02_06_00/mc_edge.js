...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_srust_Insulator',
                type: 'image',
                tag: 'img',
                rect: ['593', '25','201','85','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_srust_Insulator.png"]
            },
            {
                id: 'tire',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid56", tween: [ "style", "${_SELECT_srust_Insulator}", "opacity", '1', { fromValue: '0'}], position: 1000, duration: 333, easing: "easeOutQuad" },
