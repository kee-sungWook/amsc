...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'MAP_ov',
                type: 'image',
                rect: ['594px', '251px','72px','72px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"MAP_ov.png",'0px','0px']
            },
            {
                id: 'OCV-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid40", tween: [ "style", "${_MAP_ov}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 250 }            ]
        }
    }
}
};
