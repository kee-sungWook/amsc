...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'line_ov',
                type: 'image',
                rect: ['421px', '446px','418px','148px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"line_ov.png",'0px','0px']
            },
            {
                id: 'filter-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid7", tween: [ "style", "${_IMAGE-copy}", "opacity", '1', { fromValue: '0'}], position: 458, duration: 250 },
                { id: "eid28", tween: [ "style", "${_IMAGE-copy}", "opacity", '1', { fromValue: '1'}], position: 708, duration: 0 },
                ...
                { id: "eid25", tween: [ "style", "${_line_ov}", "opacity", '1', { fromValue: '0'}], position: 625, duration: 83 },
