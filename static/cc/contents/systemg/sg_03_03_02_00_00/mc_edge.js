...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_calliper2-5',
                type: 'image',
                tag: 'img',
                rect: ['518', '356','215','414','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_calliper2-5.png"]
            },
            {
                id: 'SELECT_calliper2-4',
                type: 'image',
                tag: 'img',
                rect: ['424', '450','56','65','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_calliper2-4.png"]
            },
            {
                id: 'SELECT_calliper2-3',
                type: 'image',
                tag: 'img',
                rect: ['350', '410','78','74','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_calliper2-3.png"]
            },
            {
                id: 'SELECT_calliper2-2',
                type: 'image',
                tag: 'img',
                rect: ['301', '380','53','64','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_calliper2-2.png"]
            },
            {
                id: 'SELECT_calliper2-1',
                type: 'image',
                tag: 'img',
                rect: ['18', '185','271','355','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_calliper2-1.png"]
            },
            {
                id: 'SELECT_calliper1',
                type: 'image',
                tag: 'img',
                rect: ['978', '364','251','575','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_calliper1.png"]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid116", tween: [ "style", "${_SELECT_calliper1}", "opacity", '1', { fromValue: '0'}], position: 1367, duration: 366, easing: "easeInQuad" },
                ...
                { id: "eid122", tween: [ "style", "${_SELECT_calliper2-5}", "opacity", '1', { fromValue: '0'}], position: 1367, duration: 366, easing: "easeInQuad" },
                { id: "eid118", tween: [ "style", "${_SELECT_calliper2-3}", "opacity", '1', { fromValue: '0'}], position: 1367, duration: 366, easing: "easeInQuad" },
                ...
                { id: "eid124", tween: [ "style", "${_SELECT_calliper2-4}", "opacity", '1', { fromValue: '0'}], position: 1367, duration: 366, easing: "easeInQuad" },
                ...
                { id: "eid126", tween: [ "style", "${_SELECT_calliper2-2}", "opacity", '1', { fromValue: '0'}], position: 1367, duration: 366, easing: "easeInQuad" },
                ...
                { id: "eid120", tween: [ "style", "${_SELECT_calliper2-1}", "opacity", '1', { fromValue: '0'}], position: 1367, duration: 366, easing: "easeInQuad" }            ]
        }
    }
}
};
