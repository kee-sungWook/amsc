...
"stage": {
    ...
    content: {
            ...
            {
                id: 'select_torqueConverter-copy',
                type: 'image',
                tag: 'img',
                rect: ['1060', '477','346','405','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"select_torqueConverter-copy.png"]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid82", tween: [ "style", "${_select_torqueConverter-copy}", "opacity", '1', { fromValue: '0'}], position: 967, duration: 233 },
