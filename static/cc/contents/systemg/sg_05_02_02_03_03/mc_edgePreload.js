...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="2400px",plHeight="1230px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['-44', '-44','88px','88px','auto', 'auto'],
    ...
    },
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['1156', '571','88px','88px','auto', 'auto'],
