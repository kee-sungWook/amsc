...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_BOTTOM-bushing_compleat',
                type: 'image',
                tag: 'img',
                rect: ['405', '727','693','221','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"BOTTOM-bushing_compleat-1.png"]
            },
            {
                id: 'TOP-Another',
                type: 'image',
    ...
    states: {
        "Base State": {
            ...
            "${_SELECT_BOTTOM-bushing_compleat}": [
                ["style", "opacity", '0']
            ],
            "${_Stage}": [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid54", tween: [ "style", "${_SELECT_BOTTOM-bushing_compleat}", "opacity", '1', { fromValue: '0'}], position: 967, duration: 366, easing: "easeOutQuad" },
