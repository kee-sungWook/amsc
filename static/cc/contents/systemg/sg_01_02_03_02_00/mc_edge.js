...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'iniecter_ov',
                type: 'image',
                rect: ['462px', '445px','261px','57px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"iniecter_ov.png",'0px','0px']
            },
            {
                id: 'line-copy',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid25", tween: [ "style", "${_iniecter_ov}", "opacity", '1', { fromValue: '0'}], position: 651, duration: 57 },
