...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_drum_brake',
                type: 'image',
                tag: 'img',
                rect: ['144', '422','484','258','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"SELECT_drum_brake.png"]
            },
            {
                id: 'disk_brake',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid434", tween: [ "style", "${_SELECT_drum_brake}", "opacity", '1', { fromValue: '0'}], position: 1500, duration: 233, easing: "easeInQuad" },
