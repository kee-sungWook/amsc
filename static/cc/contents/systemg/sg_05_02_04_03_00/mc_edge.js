...
"stage": {
    ...
    content: {
            ...
            {
                id: 'SELECT_BOTTOM-stabilizer',
                type: 'image',
                tag: 'img',
                rect: ['693', '767','402','72','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"BOTTOM-stabilizer-1.png"]
            },
            {
                id: 'BOTTOM-Another',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid56", tween: [ "style", "${_SELECT_BOTTOM-stabilizer}", "opacity", '1', { fromValue: '0'}], position: 967, duration: 366, easing: "easeOutQuad" },
