        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin:0px\">단차마모​</p>",
                            align: "center",
                        ...
                        },
                        {
                            id: 'txt2_2',
                            type: 'text',
                            rect: ['1517px', '450px', '900px', '226px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​얼라이먼트 정렬불량, 공기압불량, </p><p style=\"margin: 0px;\">타이어위치교환 등의 문제로 발생.</p><p style=\"margin: 0px; line-height: 90px;\">​(얼라인먼트 교정 필요)</p>",
                            align: "auto",
                        ...
                        },
                        {
                            id: 'txt2_1',
                            type: 'text',
                            rect: ['1517px', '420px', '822px', '60', 'auto', 'auto'],
                            opacity: '0',
                            text: "발생원인 및 조치방법",
                            align: "auto",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin:0px\"></p><p style=\"margin:0px\"> </p><p style=\"margin:0px\">트래드면이 불규칙적으로</p><p style=\"margin:0px\">마모되는 현상​</p>",
                            align: "auto",
                            font: ['나눔고딕', [55, ""], "rgb(0,73,141)", "normal", "none", "normal", "break-word", ""]
                        },
                        {
            ...
            "tireMovie": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            rect: ['0px', '300px', '62', '76', 'auto', 'auto'],
                            id: 'airMovie',
                            symbolName: 'airMovie',
                            type: 'rect'
                        },
                        {
                            transform: [[], ['-21'], [], ['0.7', '0.7']],
                            id: 'airMovieCopy',
                            symbolName: 'airMovie',
                            rect: ['0px', '300px', '62', '76', 'auto', 'auto'],
                            type: 'rect'
                ...
                timeline: {
                    duration: 708.33333333333,
                    autoPlay: true,
                    data: [
                            [ "eid173", "trigger", 0, function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['play', '${airMovie}', [] ] ],
                            [ "eid174", "trigger", 125, function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['play', '${airMovieCopy}', [] ] ]
                    ]
                }
            },
            "carMove": {
            ...
            "mamoMovie": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '0px', '147', '269', 'auto', 'auto'],
                            tag: 'img',
                            id: 'mamo5th',
                            opacity: '0',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/mamo5th.png']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '147px', '269px']
                        }
                    }
                },
                timeline: {
