        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin:0px\">숄더마모​</p>",
                            align: "center",
                        ...
                        },
                        {
                            id: 'txt2_2',
                            type: 'text',
                            rect: ['1517px', '430px', '900px', '288px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​공기압이 부족한 상태로 운행하거나, 서스팬션의 문제로 발생.</p><p style=\"margin: 0px; line-height: 91px;\">서스팬션의 문제가 없을 경우 </p><p style=\"margin: 0px; line-height: 36px;\">타이어 교환 후 얼라이먼트 정렬.</p><p style=\"margin: 0px;\">​</p>",
                            align: "auto",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​타이어의 한쪽 숄더 전체 또는 </p><p style=\"margin: 0px;\">일부가 마모되는 현상.</p><p style=\"margin: 0px;\">​</p>",
                            align: "auto",
                            font: ['나눔고딕', [55, ""], "rgb(0,73,141)", "normal", "none", "normal", "break-word", ""]
                        },
                        {
            ...
            "carMove": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            rect: ['938px', '216px', '133', '341', 'auto', 'auto'],
                            id: 'errMovie1',
                            symbolName: 'errMovie1',
                            type: 'rect'
                        },
                        {
                            transform: [[], [], [], ['-1']],
                            id: 'errMovie1Copy',
                            symbolName: 'errMovie1',
                            rect: ['237px', '216px', '133', '341', 'auto', 'auto'],
                            type: 'rect'
                        },
                        {
            ...
            "mamoMovie": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '0px', '60', '334', 'auto', 'auto'],
                            tag: 'img',
                            id: 'mamo3rd',
                            opacity: '0',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/mamo3rd.png']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '60px', '334px']
                        }
                    }
                },
                timeline: {
