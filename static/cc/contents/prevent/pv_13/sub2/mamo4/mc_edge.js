        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin:0px\">깃털마모​</p>",
                            align: "center",
                        ...
                        },
                        {
                            id: 'txt2_2',
                            type: 'text',
                            rect: ['1517px', '490px', '900px', '226px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​얼라이먼트 정렬불량 및 코너링 </p><p style=\"margin: 0px;\">또는 미끄러짐이 많을 때 나타 남.</p><p style=\"margin: 0px; line-height: 94px;\">​(얼라이먼트 교정 필요)</p>",
                            align: "auto",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​리브 한쪽면이 연속적으로 마모되어</p><p style=\"margin: 0px;\">반대편 트래드가 깃털처럼 마모됨.</p>",
                            align: "auto",
                            font: ['나눔고딕', [55, ""], "rgb(0,73,141)", "normal", "none", "normal", "break-word", ""]
                        },
                        {
            ...
            "mamoMovie": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '0px', '29', '334', 'auto', 'auto'],
                            tag: 'img',
                            id: 'mamo4th',
                            opacity: '0',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/mamo4th.png']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '29px', '334px']
                        }
                    }
                },
                timeline: {
