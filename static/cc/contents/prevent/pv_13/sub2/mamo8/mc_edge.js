        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin:0px\">중앙마모​</p>",
                            align: "center",
                        ...
                        },
                        {
                            ...
                            symbolName: 'btn2',
                            type: 'rect',
                            rect: ['1520px', '1039px', '850px', '124', 'auto', 'auto'],
                            opacity: '0',
                            transform: [[],[],[],['0.9','0.9']]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['1520px', '878px', 'undefined', 'undefined', 'auto', 'auto']
                        },
                        {
                            id: 'btn1',
                            symbolName: 'btn1',
                            display: 'block',
                            type: 'rect',
                            rect: ['1520px', '878px', '850px', '124', 'auto', 'auto'],
                            opacity: '0',
                            transform: [[],[],[],['0.9','0.9']]
                        },
                        {
                            id: 'txt2_2',
                            type: 'text',
                            rect: ['1517px', '490px', '900px', '288px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​과도한 공기압으로 장시간 운행 시 </p><p style=\"margin: 0px;\">나타나며, 권장하는 림보다 작은 것</p><p style=\"margin: 0px;\">을 장착 시 발생 됨.</p><p style=\"margin: 0px; line-height: 96px;\">​(공기압 점검 및 림 교환)</p>",
                            align: "auto",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​타이어 트래드면이 골고루 일정하게</p><p style=\"margin: 0px;\">마모되는게 아니라 중앙부분만 마모</p><p style=\"margin: 0px;\">되는 현상.</p><p style=\"margin: 0px;\">​</p>",
                            align: "auto",
                            font: ['나눔고딕', [55, ""], "rgb(0,73,141)", "normal", "none", "normal", "break-word", ""]
                        },
                        {
            ...
            "mamoMovie": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '0px', '107', '334', 'auto', 'auto'],
                            tag: 'img',
                            id: 'mamo8th',
                            opacity: '0',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/mamo8th.png']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '107px', '334px']
                        }
                    }
                },
                timeline: {
