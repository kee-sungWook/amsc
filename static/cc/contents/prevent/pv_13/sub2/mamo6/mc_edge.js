                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin:0px\">원형마모​</p>",
                            align: "center",
                        ...
                        },
                        {
                            id: 'txt2_2',
                            type: 'text',
                            rect: ['1517px', '440px', '900px', '322px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​공기압불량, 과적, 타이어위치교환 </p><p style=\"margin: 0px;\">등의 문제로 발생 됨.</p><p style=\"margin: 0px; line-height: 88px;\">적절한 공기압유지, 타이어위치교환,</p><p style=\"margin: 0px; line-height: 48px;\"> 적정 하중유지.</p><p style=\"margin: 0px;\">​</p>",
                            align: "auto",
                        ...
                        },
                        {
                            id: 'txt2_1',
                            type: 'text',
                            rect: ['1517px', '410px', '822px', '60', 'auto', 'auto'],
                            opacity: '0',
                            text: "발생원인 및 조치방법",
                            align: "auto",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​양쪽 숄더 부분만 마모되고 </p><p style=\"margin: 0px;\">중앙 부분은 마모되지 않음.</p>",
                            align: "auto",
                            font: ['나눔고딕', [55, ""], "rgb(0,73,141)", "normal", "none", "normal", "break-word", ""]
                        },
                        {
                    ...
                    dom: [
                        {
                            ...
                            opacity: '0',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/mamo6th.png']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
