        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin:0px\">조기마모​</p>",
                            align: "center",
                        ...
                        },
                        {
                            ...
                            symbolName: 'btn2',
                            type: 'rect',
                            rect: ['1520px', '1019px', '850px', '124', 'auto', 'auto'],
                            opacity: '0',
                            transform: [[],[],[],['0.9','0.9']]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['1520px', '858px', 'undefined', 'undefined', 'auto', 'auto']
                        },
                        {
                            id: 'btn1',
                            symbolName: 'btn1',
                            display: 'block',
                            type: 'rect',
                            rect: ['1520px', '858px', '850px', '124', 'auto', 'auto'],
                            opacity: '0',
                            transform: [[],[],[],['0.9','0.9']]
                        },
                        {
                            id: 'txt2_2',
                            type: 'text',
                            rect: ['1517px', '490px', '900px', '286px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin:0px\"></p><p style=\"margin:0px\"> </p><p style=\"margin:0px\">무리한 급출발, 급가속, 급코너, </p><p style=\"margin:0px\">커브길 많은 노면운행, 운전자의</p><p style=\"margin:0px\">잘못된 운전습관 등의 원인</p><p style=\"margin: 0px; line-height: 96px;\">(휠얼라이먼트 조정, 드럼 점검)​</p>",
                            align: "auto",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​타이어 바닥이 일정하게 마모되지 </p><p style=\"margin: 0px;\">않고 마모 정도가 불규칙적으로 </p><p style=\"margin: 0px;\">층층히 마모 됨</p>",
                            align: "auto",
                            font: ['나눔고딕', [55, ""], "rgb(0,73,141)", "normal", "none", "normal", "break-word", ""]
                        },
                        {
            ...
            "mamoMovie": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '0px', '89', '334', 'auto', 'auto'],
                            tag: 'img',
                            id: 'mamo2nd',
                            opacity: '1',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/mamo2nd.png']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '89px', '334px']
                        }
                    }
                },
                timeline: {
