...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'gear_mov',
                type: 'rect',
                rect: ['244', '362','auto','auto','auto', 'auto']
            },
            {
                id: 'bg03',
                type: 'image',
                rect: ['243px', '352px','24px','19px','auto', 'auto'],
            ...
            },
            {
                id: 'butt',
                type: 'rect',
                rect: ['1511', '895','auto','auto','auto', 'auto']
            },
            {
                id: 'Text2',
                type: 'text',
                rect: ['143px', '58px','auto','auto','auto', 'auto'],
                text: "연료라인의 세정은 연료라인 내의 이물질을 제거하고 연료라인 관련 부품의 내구성을 향상시킵니다.",
                align: "left",
                font: ['Arial, Helvetica, sans-serif', 30, "rgba(0,74,141,1.00)", "400", "none", "normal"]
            }],
            symbolInstances: [
            {
                id: 'INJECTION2',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid605", tween: [ "style", "${_INJECTION1}", "display", 'none', { fromValue: 'block'}], position: 1000, duration: 0 },
                { id: "eid30", tween: [ "style", "${_EQUIPMENT}", "left", '1140px', { fromValue: '1140px'}], position: 0, duration: 0 },
                { id: "eid604", tween: [ "style", "${_INJECTION2}", "display", 'none', { fromValue: 'block'}], position: 0, duration: 0 },
                { id: "eid606", tween: [ "style", "${_INJECTION2}", "display", 'block', { fromValue: 'none'}], position: 1000, duration: 0 },
                ...
                { id: "eid607", trigger: [ function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['play', '${_ani_01}', [] ], ""], position: 33 }            ]
        }
    }
},
"EQUIP_LIGHT2": {
