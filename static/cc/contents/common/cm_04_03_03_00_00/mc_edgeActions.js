...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 1000, function(sym, e) {
         ...
         sym.getSymbol("POLLUTION_DRUM").play("brakeOn");
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 3000, function(sym, e) {
         ...
         sym.getSymbol("POLLUTION_DRUM").play("brakeOff");
   ...
   //Edge symbol end:'DRUM_POLLUTION_movie'
   ...
   (function(symbolName) {   
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 900, function(sym, e) {
         sym.stop();
         sym.getSymbol("DRUM_POLLUTION_movie").play("slowStop");
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 1867, function(sym, e) {
         sym.stop();
         sym.getSymbol("DRUM_POLLUTION_movie").play(0);

      });
      //Edge binding end

   })("POLLUTION_DRUM");
   //Edge symbol end:'POLLUTION_DRUM'
