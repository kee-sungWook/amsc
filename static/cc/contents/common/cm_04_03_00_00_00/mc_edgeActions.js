...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   //Edge symbol: 'smallPic5_1'
   (function(symbolName) {   
   
   })("smallPic6");
   //Edge symbol end:'smallPic6'

   //=========================================================
   
   //Edge symbol: 'smallPic6_1'
   (function(symbolName) {   
   
   })("smallPic7");
   //Edge symbol end:'smallPic7'
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${smallPic1}", "click", function(sym, e) {
         var thisNum = "1";
         ...
         var vid = $("<iframe width='1806' height='1077' src='../cm_04_03_0" + thisNum +"_00_00/mc.html' frameborder='0' scrolling='no'></iframe>");
      ...
      Symbol.bindElementAction(compId, symbolName, "${smallPic2}", "click", function(sym, e) {
         var thisNum = "2";
      ...
      Symbol.bindElementAction(compId, symbolName, "${smallPic3}", "click", function(sym, e) {
         var thisNum = "3";
      ...
      Symbol.bindElementAction(compId, symbolName, "${smallPic4}", "click", function(sym, e) {
         var thisNum = "4";
      ...
      Symbol.bindElementAction(compId, symbolName, "${smallPic5}", "click", function(sym, e) {
         var thisNum = "5";
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-13633348");