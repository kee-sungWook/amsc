        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "텐션 베어링 노화에 따른 벨트장력<br>감소에 따라 나타날 수 있는 증상",
                            align: "auto",
            ...
            "timing_belt1_line_movie": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['-126px', '478px', '36', '19', 'auto', 'auto'],
                ...
                timeline: {
                    ...
                    data: [
                        [
                            ...
                            "linear",
                            "${timing_belt1_mover}",
                            [[-108, 487.5, 0, 0, 0, 0,0],[-159.33, 276.29, -104.22, -378.46, -12.87, -46.72,217.36],[-77.73, 80.12, 107.58, -79.36, 36.07, -26.61,446.43],[18, 9.5, 0, 0, 0, 0,565.39]]
                        ]
                    ]
                }
            },
            ...
            "TentionBearing_movie": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            rect: ['2', '2', '84px', '91px', 'auto', 'auto'],
                            id: 'tention_bearing_red',
                            opacity: '0.6000000238418579',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/tention_bearing_red.png', '0px', '0px']
                        },
                        {
                            id: 'blackOval_movie2',
