...
"smallPic4": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['1px', '424px', '399px', 'auto', 'auto', 'auto'],
                    font: ['Arial, Helvetica, sans-serif', 50, 'rgba(0,0,0,1)', 'normal', 'none', 'normal'],
                    id: 'Text2',
                    text: '',
                    align: 'center',
                    type: 'text'
            ...
            dom: [
                {
                    id: 'smallPic3',
                    type: 'rect',
                    rect: ['1194px', '344px', 'auto', 'auto', 'auto', 'auto']
                },
                {
                    id: 'smallPic2',
                    type: 'rect',
                    rect: ['719px', '396px', 'auto', 'auto', 'auto', 'auto']
                },
                {
                    id: 'smallPic1',
                    type: 'rect',
