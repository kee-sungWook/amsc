...
"stage": {
    ...
    content: {
            dom: [
            {
                id: 'BRAKE_CYLINDER',
                type: 'rect',
                rect: ['598', '182','auto','auto','auto', 'auto']
            },
            {
                id: 'BRAKE',
                type: 'rect',
                rect: ['260px', '481px','auto','auto','auto', 'auto'],
                transform: [[],[],[],['0.8','0.8']]
            },
            {
                id: 'NORMAL_DRUM',
                type: 'rect',
                rect: ['558px', '638px','auto','auto','auto', 'auto'],
                transform: [[],[],[],['0.8','0.8']]
            },
            {
                id: 'guideLine',
                type: 'image',
                tag: 'img',
                rect: ['478', '337','934','689','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"guideLine.png"]
            },
            {
                id: 'txt1',
                type: 'text',
                rect: ['257', '290','384','66','auto', 'auto'],
                text: "브레이크 패드",
                align: "auto",
            ...
            },
            {
                id: 'txt2',
                type: 'text',
                rect: ['1262', '260','324','66','auto', 'auto'],
                text: "브레이크 액",
                align: "auto",
                font: ['굴림', 60, "rgb(0,0,0)", "normal", "none", "normal"]
            },
            {
                id: 'txt3',
                type: 'text',
                rect: ['1102', '974','384','66','auto', 'auto'],
                text: "브레이크 드럼",
                align: "auto",
                font: ['굴림', 60, "rgb(0,0,0)", "normal", "none", "normal"]
            }],
