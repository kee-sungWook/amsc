...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${closealls}", "click", function(sym, e) {
         sym.getComposition().getStage().stop(0);
   ...
   //Edge symbol: 'pic_src2_1'
   (function(symbolName) {   
   
   })("pic_src3");
   //Edge symbol end:'pic_src3'
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${smallPic3}", "click", function(sym, e) {
         sym.getComposition().getStage().getSymbol("bigPics").$("bigPic3").show();
         sym.getComposition().getStage().play("showBig");
         sym.getComposition().getStage().getSymbol("smallPics").hide();
   ...
   //Edge symbol end:'bigPic3'

})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-5260140");